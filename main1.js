...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  */
  ...
  },{"./gsap-core.js":"TNS6","./CSSPlugin.js":"bp4Z"}],"yBhi":[function(require,module,exports) {
  "use strict";
  ...
  var Intro = /*#__PURE__*/function () {
    function Intro(el) {
      ...
      this.DOM.circleText = _toConsumableArray(this.DOM.el.querySelectorAll('text.circles__text')); // total of texts
  
      this.circleTextTotal = this.DOM.circleText.length; // initial setudp
    ...
    _createClass(Intro, [{
      ...
      value: function start() {
        this.startTL = _gsap.gsap.timeline().addLabel('start', 0) // scale in the texts & enter button and fade them in
      ...
      value: function enter() {
        ...
        this.startTL.kill(); // remove any event listener on the button
        ...
        }, 'start') // show the content elements
  ...
  exports.Intro = Intro;
  },{"../utils":"MgTz","gsap":"TpQl"}],"C3Xv":[function(require,module,exports) {
  "use strict";
  ...
  Promise.all([(0, _utils.preloadFonts)('kxo3pgz')]).then(function () {
    ...
    document.body.classList.remove('loading'); // start intro animation
